 ...
 * help the Sheriff, but there is also a Renegade pursuing his own goal!
 * In BANG! each player plays one of these roles, and represents a famous Wild 
...
public class BangGame implements StandardGame {
     ...
     *
     * See Figure below for distances from player A (seven players shown)
     * A,A -> 0; A,B -> 1; A,C -> 2; A,D -> 3; A,E -> 3; A,F -> 2; A,G -> 1 
     * 
     *        D_ _E 
     *  ^  C /     \ F  ^
     *  |   |       |   |
